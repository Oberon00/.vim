...
execute 'syn match rstRole'
      \ . ' /:\zs' . s:ReferenceName . '\ze:`'
      \ . '\|`:\zs' . s:ReferenceName . '\ze:/'
      \ . ' contains=@NoSpell nextgroup=rstInterpretedTextOrHyperlinkReference'

syn cluster rstCruft                contains=rstEmphasis,rstStrongEmphasis,
      \ rstInterpretedTextOrHyperlinkReference,rstInlineLiteral,rstSubstitutionReference,
...
syn region rstCodeBlock contained matchgroup=rstDirective
      \ start=+\%(sourcecode\|code\%(-block\)\=\|tikz\)::\_s+
      \ skip=+^$+
      \ end=+^\s\@!+
      \ contains=@NoSpell
